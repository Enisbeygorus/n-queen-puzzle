           ...
           <div className={classes.MainMenuDiv}>
                ...
                <div className={classes.MainMenuDivDiv}>
                    <h1 className={classes.MainMenuDivDivSpan1}>
                            ...
                            <span className={classes.MainMenuDivDivSpan2}>N queen puzzle briefing</span>
                    </h1>                      
            </div>    
                </header>
                <main className={classes.MainMenuMain}>
                    <section className={classes.MainMenuMainSection1}>
                        ...
                        <div className={classes.MainMenuMainSection1Div2}>
                            ...
                            <div className={classes.MainMenuMainSection1Div2}>
                            <div className={classes.MainMenuMainSection1Div2Div1} style={{padding: '50px 0px'}}>
                                 <img src={HistoryChess} alt=""/> 
                            </div>
                                <div>
                                     <h3>History</h3>
                                     <p>Chess composer Max Bezzel published the eight queens puzzle in 1848. Franz Nauck published the first solutions in 1850. Nauck also extended the puzzle to the n queens problem, with n queens on a chessboard of n×n squares.
...
In 1972, Edsger Dijkstra used this problem to illustrate the power of what he called structured programming. He published a highly detailed description of a depth-first backtracking algorithm.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div className={classes.MainMenuMainSection1Div1}>
                       ...
                       <div className={classes.MainMenuMainSection1Div2}>
                             <div className={classes.MainMenuMainSection2BruteForce}>
                                ...
                                <p>The problem of finding all solutions to the 8-queens problem can be quite computationally expensive, as there are 4,426,165,368 possible arrangements of eight queens on an 8×8 board, but only 92 solutions. It is possible to use shortcuts that reduce computational requirements or rules of thumb that avoids brute-force computational techniques. For example, by applying a simple rule that constrains each queen to a single column (or row), though still considered brute force, it is possible to reduce the number of possibilities to 16,777,216 (that is, 88) possible combinations. Generating permutations further reduces the possibilities to just 40,320 (that is, 8!), which are then checked for diagonal attacks.</p>
                            </div>
                            <div className={classes.MainMenuMainSection1Div2}>
                            <div className={classes.MainMenuMainSection1Div2Div1}>
                                <h3>More&nbsp; efficient &nbsp;Algorithm </h3>
                                <p>A more efficient algorithm (which can be implemented recursively or not) is to start in the first column in the top left, then it then places a queen in the second column and moves it until it finds a place where it cannot be hit by the queen in the first column.
...
It then places a queen in the third column and moves it until it cannot be hit by either of the first two queens. Then it continues this process with the remaining columns. If there is no place for a queen in the current column the program goes back to the preceding column and moves the queen in that column. If the queen there is at the end of the column it removes that queen as well and goes to the preceding column. If the current column is the last column and a safe place has been found for the last queen, then a solution of the puzzle has been found. If the current column is the first column and its queen is being moved off the board then all possible configurations have been examined, all solutions have been found, and the algorithm terminates.</p>
                            ...
                            <div style={{position: 'relative', padding: '80px 0px 0px 0px'}}>
